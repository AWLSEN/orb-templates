...
steps = [
  ...
  "GH_VERSION=2.91.0 && curl -fsSL \"https://github.com/cli/cli/releases/download/v${GH_VERSION}/gh_${GH_VERSION}_linux_amd64.tar.gz\" | tar xz -C /tmp && cp /tmp/gh_${GH_VERSION}_linux_amd64/bin/gh /agent/packages/bin/gh && rm -rf /tmp/gh_${GH_VERSION}_linux_amd64 && /agent/packages/bin/gh --version",
